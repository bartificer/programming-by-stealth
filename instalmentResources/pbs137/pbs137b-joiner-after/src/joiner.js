/**
 * A fork of `is.js` ported to ES 6 and regularly maintained.
 * @external module:is-it-check
...
class Joiner {
  ...
  constructor(conjunction='&', quoteWith='', doSort=false) {
    ...
    if (is.not.string(conjunction)) conjunction = '&';
    if (is.not.string(quoteWith)) quoteWith = '';
