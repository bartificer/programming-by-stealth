class Nerdtouche{
	 ...
	 */
	static set length(l){
		throw new Error(`Nerdtouches will always be ${this.length} long!`);
	}
	 ...
	 * that doesn't contain exactly one Unicode character.
	 */
	...
	asHTML(){
		...
		$nerdtouche.addClass('badge badge-secondary badge-pill p-1 m-1 align-middle');
		$nerdtouche.css({
			fontSize: '0.5em',
			lineHeight: 1.5
		});
		return $nerdtouche[0].outerHTML;
	}
}