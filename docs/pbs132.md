...
Next I re-ordered the sections in the side bar (the *Global* section can't be moved for some odd reason), and configured the sidebar to only show nested detail in the current section:
