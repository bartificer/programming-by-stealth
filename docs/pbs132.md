...
(all responsive and clean)
* https://github.com/ankitskvmdam/clean-jsdoc-theme (very configurable, recently updated)
* https://github.com/clenemt/docdash (very configurable, recently updated, but I don't like the purple)
* https://github.com/Nijikokun/minami (not very configurable and not updated in 2 years, but my favourite look with the different colours for different types of thing)
