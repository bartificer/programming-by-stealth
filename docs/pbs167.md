...
Let's start nice and simple with what programming language theorists often somewhat jokingly refer to as *syntactic sugar* — these are little additions to a language's syntax that don't add any new capabilities, but make your code a little easier to read and write.
