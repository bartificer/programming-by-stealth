...
echo 'hello world' | ./pbs150c-shouter.sh menu.txt
echo 'hello world' | ./pbs150c-shouter.sh -b menu.txt
...
What's left to do? Mostly, just a little house keeping!
