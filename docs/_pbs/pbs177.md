...
First, we'll create a very basic settings file for the site.
...
This will convert the contents of the `docs` folder to HTML + CSS and write the generated files to the folder `docs/_site`, then start a locally running web server on port `4000`. You'll see the URL to point your browser at in the output, it will be `http://127.0.0.1:4000`. Open that URL in your browser and admire your site!
