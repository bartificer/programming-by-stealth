...
Our approach in this series will be to start by learning how to Enable GitHub Pages and host a simple web app, then we'll move on to using Jekyll's content management features with an existing theme, and we'll finish the series by learning how to extend exiting themes and create entirely custom themes.
