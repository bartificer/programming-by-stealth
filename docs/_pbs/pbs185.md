...
Fundamentally, you're just writing SASS code that makes use of variables, maps, mixins, functions, and pre-defined CSS style declarations imported from external files. There is no Bootstrap-specific syntax, it's just someone else's SASS code used as a starting point for your own.

Because there's no Bootstrap-specific version of SASS, the best way to illustrate the possibilities is with a worked example.
