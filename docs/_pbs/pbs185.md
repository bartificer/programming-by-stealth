...
When developing worked examples I prefer to use the PBS brand colours and my base, but in this case, just like I chose to do in PBS TO CHECK, I've chosen to use the Bartificer Creations corporate style instead. Why? For the same reason as last time, it was designed to be Bootstrap-compatible by the design company.
