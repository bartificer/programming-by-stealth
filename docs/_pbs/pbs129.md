...
>
> Thus, as you enjoy listening to this episode and following along with these show notes, understand that the theory of using a linter is still correct, but the implementation details for ESLint no longer are.
>
> More information about the change from .eslintrc to eslint.config.js can be found in these ESLint blog posts:
>
