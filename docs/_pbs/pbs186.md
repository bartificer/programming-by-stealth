...
Before we switch our focus back to building statically generated websites with Jekyll, we need to take one more short diversion. Before we took a break from the topic we described the mechanisms for developing the *look* of a Jekyll website, and after our break we'll shift our focus to how Jekyll allows you to structure your content. In the modern world, that means ensuring the content you publish on your Jekyll sites is properly indexed by search engines, and looks good when embedded into social media posts. This means looking at two related but subtly different technologies — the traditional metadata headers developed early in the web's history to support search engines, and the much newer OpenGraph protocol developed to allow web pages enrich their preview cards in social media posts.
...
The official standard names are very much search-engine focused, so they're still important, and you should still add them to your content management system themes, but their importance is waning in our modern social media and AI-lead world.
...
For convenience, we'll do what most people do, and refer to the official headers are *SEO Headers* in this instalment.

LEFT OFF HERE ON REFINEMENT PASS!!!
...
The approach is basically the same, thought there's more code because there are more headers!
