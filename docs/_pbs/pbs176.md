...
Before going any further, open the placeholder file `docs/index.html` in your browser. Also, **copy this file to a temporary location outside of your repo**, we'll want to quickly and easily restore it later.
