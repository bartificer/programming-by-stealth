...
<audio controls src="https://media.blubrry.com/nosillacast/traffic.libsyn.com/nosillacast/PBS_2026_04_11.mp3?autoplay=0&loop=0&controls=1">Your browser does not support HTML 5 audio 🙁</audio>

You can also <a href="https://media.blubrry.com/nosillacast/traffic.libsyn.com/nosillacast/PBS_2026_04_11.mp3" >Download the MP3</a>

Read an unedited, auto-generated transcript with chapter marks:  <a href="https://podfeet.com/transcripts/PBS_2026_04_11.html">PBS_2026_04_11</a>
...
>
> This means initial values can't reference the values of other custom properties. That does not mean you can't have one custom property derive its value from another, you just can't assign that value with the `@property` declaration. Usually, that means you simply declare a value at the root level using the  `:root` selector and let it cascade. You'll notice this approach used in some of the examples below.
{: .warning}
...
CSS function are too broad and advanced a topic to explore in detail here, so we're going to limit ourselves to just the two functions you're most likely to need. If this little preview whets your appetite, you can explore CSS's full set of functions in [this MDN article](https://developer.mozilla.org/en-US/docs/Web/CSS/Reference/Values/Functions).
...
3. Overrides the value of one of the variables on specific subsets of the page to demonstrate nesting — specifically, overrides the body font custom property within quotations.
...
1. The at-rules:
   1. An `@import` rule to import three Google Fonts ([these three to be specific](https://fonts.google.com/share?selection.family=Indie+Flower%7CUbuntu+Mono:ital,wght@0,400;0,700;1,400;1,700%7CUbuntu+Sans:ital,wght@0,100..800;1,100..800))
