...
Nearly two-and-a-half years after this instalment was delivered, we learned in [PBS 176 *how* to deploy a JavaScript web app on GitHub Pages using Webpack & GitHub Actions](https://pbs.bartificer.net/pbs176). 
