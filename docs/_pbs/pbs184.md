...
When recorded will start at [Worked Example — A Multi-Section Web Page](#partb). You can read ahead if you, like but it's not proofread yet!
...
<h2 id="partb">Instalment Resources (Only Needed for Part B)</h2>
