...
My working solution is available at [raw.githack.com/...](https://raw.githack.com/NosillaCast/a-world-clock/two-working-search-clocks/index.html) and the source code is available at [github.com/...](https://github.com/NosillaCast/a-world-clock/tree/two-working-search-clocks).
...
![Allison Static Clocks](../instalmentResources/pbs100/allison-static-clocks.png)

Allison's completed assignment with chooseable, time-shiftable, sendable clocks:

![Allison's Chooseable, Time-shiftable, Sendable Clocks](../instalmentResources/pbs100/allison-time-shifting-sendable-clocks.png)
