...
We've covered the most important ground when it comes to writing doc comments — we saw how to describe modules, classes, functions, and variables, and even how to define our own types. What we haven't looked at yet is how to control the way those doc comments get rendered as a website. That will be the focus of the next instalment.
