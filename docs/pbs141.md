...
Relationships are added at the top level of the diagram, one relationship per line. The basic structure is a class name to start and end, with and ASCII-art arrow connecting them, and optionally quoted cardinalities on each end:
