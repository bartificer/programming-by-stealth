...
```bash
echo "'stdin arg1' 'stdin arg2'" | xargs ./pbs152a-argPrinter.sh 'initial arg 1' 'initial arg 2'
```
...
```bash
./pbs152a-argPrinter.sh 'initial arg 1' 'initial arg 2' 'stdin arg1' 'stdin arg2'
```
