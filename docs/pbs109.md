...
## Updating the PBS Branching Strategy for SemVar & Structured Commits — Take 3
...
* **Releases**
	...
	3. Releases will be named using SemVar.
	4. Releases must be on the `main` branch.
	5. All releases must be tagged with their SemVar pre-fixed with a lower-case `v`, e.g. `v1.2.3`
...
![The repository tree showing the remnant of the feat-carousel-links branch with two commits on it](assets/pbs108/screenshot-GitKraken-structure.png)
