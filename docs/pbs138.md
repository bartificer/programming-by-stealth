...
You'll find the complete file in the `pbs138-1` folder in the instalment ZIP, copy that file into your folder. Now that you have the config in place, let's have a look at it:
