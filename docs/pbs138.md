...
Next, we need to create a simple Webpack config that will copy our HTML file and bundle our JS and CSS files. The Webpack config file will be webpack.config.js with the following:
