...
Note that GitHub's terminology around pull requests can be a little confusing, especially the term *base*. Because you're requesting a pull, the base is the repository and you are offering your changes to, not the changes you are offering. Your repository is referred to as the *head repository* of the PR, and the branch on your repo you're offering to be pulled is referred to as the *compare*.
