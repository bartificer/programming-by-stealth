...
If you'd like to take a little sneak-peak, why not check out the Perl version of the XKPasswd code, or, an abortive first attempt of a JavaScript port on GitHub:
