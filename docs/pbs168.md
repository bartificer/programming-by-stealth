...
Clearly, there's room for some syntactic sugar, some kind of optional additional syntax for better representing simple nested data structure? Of course there is, and that's the perfect teaser to end this instalment on!
